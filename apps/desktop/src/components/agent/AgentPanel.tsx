...
function UserMessageBubble({
	...
	if (editing) {
		return (
			<div className="flex">
				<div className="w-full rounded-lg border-2 border-primary/50 bg-primary/5 px-3 py-2">
					<textarea
						ref={editRef}
	...
	return (
		<div className="group flex flex-col items-end gap-1 min-w-0">
			<div className="w-fit rounded-lg bg-primary px-3 py-2 text-primary-foreground">
